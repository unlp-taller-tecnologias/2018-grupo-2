...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "SecurityBundle:Collector:security.html.twig", "/opt/lampp/htdocs/bioParque/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views/Collector/security.html.twig");
    }
}
