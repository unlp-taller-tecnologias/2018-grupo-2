...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "DebugBundle:Profiler:dump.html.twig", "/opt/lampp/htdocs/bioParque/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views/Profiler/dump.html.twig");
    }
}
