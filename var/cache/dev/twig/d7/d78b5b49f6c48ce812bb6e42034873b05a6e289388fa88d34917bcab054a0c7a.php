...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "DebugBundle:Profiler:dump.html.twig", "/opt/lampp/htdocs/2018-grupo-2/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views/Profiler/dump.html.twig");
    }
}
